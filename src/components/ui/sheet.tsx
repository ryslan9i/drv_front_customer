...
const sheetVariants = cva(
  'fixed z-50 flex flex-col gap-4 bg-card p-6 shadow-lg transition ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:duration-200 data-[state=open]:duration-300 border-border',
  {
    variants: {
      side: {
        right:
        ...
        left: 'inset-y-0 left-0 h-full w-full border-r sm:max-w-lg data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left',
      },
    },
